...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pr_splitBinaryStr_insertIntoTransmitter`(IN strBinary varchar(20))
BEGIN
...
--    select v_d1, v_d2, v_d3, v_d4, v_d5;
...
-- Dump completed on 2016-04-11  4:14:54
