  ...
  private void populateRoleComboBox(Organization organization){
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if(organization instanceof CitizenOrganization){
            CitizenEmployee ee = new CitizenEmployee();
            ee.setName(name);
            ...
            if(role instanceof FoodDistributionSupervisorRole){
            ...
            if(role instanceof FoodStandardSupervisorRole){
    ...
    private void cboOrganizationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboOrganizationActionPerformed
        ...
        if (organization != null){
            ...
            if(organization instanceof CitizenOrganization || organization instanceof RestaurantOrganization){
