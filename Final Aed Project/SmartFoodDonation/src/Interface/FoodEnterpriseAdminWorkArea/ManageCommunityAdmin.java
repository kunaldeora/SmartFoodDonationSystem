...
public class ManageCommunityAdmin extends javax.swing.JPanel {
    ...
    public void populateCombobox(){
        ...
        if (enterprise instanceof FoodManagementEnterprise){
            ...
            for (Community community : foodManagementEnterprise.getCommunityList()){
    ...
    public void populateTable(){
        ...
        if (enterprise instanceof FoodManagementEnterprise){
            ...
            for(Community community : foodManagementEnterprise.getCommunityList() ){                
                ...
                for (UserAccount useraccount : community.getCommunityOrganization().getUserAccountDirectory().getUserAccountList()){
