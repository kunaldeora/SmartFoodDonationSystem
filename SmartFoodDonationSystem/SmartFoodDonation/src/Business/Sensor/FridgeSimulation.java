...
public class FridgeSimulation {
    ...
    private void generateLists(){
        ...
        try {
            ...
            Date purchaseDate1 = formatedDate.parse("2015-11-11");
            Date purchaseDate2 = formatedDate.parse("2015-11-13");
            Date purchaseDate3 = formatedDate.parse("2015-11-02");
            Date purchaseDate4 = formatedDate.parse("2015-11-20");
