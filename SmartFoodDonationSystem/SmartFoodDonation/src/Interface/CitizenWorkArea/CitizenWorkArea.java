 ...
 */
package Interface.CitizenWorkArea;
 ...
 * @author kunal
 */
public class CitizenWorkArea extends javax.swing.JPanel {
    ...
    private CitizenEmployee citizenEmployee;
    
    public CitizenWorkArea(JPanel userProcessContainer, UserAccount userAccount) {
        this.userProcessContainer = userProcessContainer;
        this.userAccount = userAccount;
        community=  userAccount.getEmployee().getCommunityAssociated();
        citizenEmployee = (CitizenEmployee) userAccount.getEmployee();
        initComponents();
        populateTable();  
    ...
    private void populateFridgeItems(){
          ...
          SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
           //CitizenEmployee ee = (CitizenEmployee)  userAccount.getEmployee();      
           for(Food food : citizenEmployee.getFoodDirectory().getFoodDirectory()){
    ...
    private void populateDonatedHistory(){
        ...
        model.setRowCount(0);
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
        for(Food food : citizenEmployee.getFoodDonatedHistory().getFoodDirectory()  ){
    ...
    private void btnDonationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDonationActionPerformed
        ...
        foodCollection.setCitizen(citizenEmployee);
        foodCollection.setStatus("New Request");
        
        Organization org =  community.getFoodCollectionOrg();
        org.getWorkQueue().getWorkRequestList().add(foodCollection);
        //userAccount.getWorkQueue().getWorkRequestList().add(foodCollection);
        citizenEmployee.getFoodDirectory().getFoodDirectory().remove(food);
        citizenEmployee.getFoodDonatedHistory().getFoodDirectory().add(food);
        populateTable();
        populateDonatedHistory();
