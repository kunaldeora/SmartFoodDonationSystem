 ...
 */
package Interface.FoodStandardSupervisor;
...
public class FoodStandardSupervisorWorkArea extends javax.swing.JPanel {
    ...
    private void btnApproveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApproveActionPerformed
        ...
        foodDistributionWorkRequest.setCitizen(request.getCitizen());
      
        Organization org = community.getFoodDistributionOrg();
        org.getWorkQueue().getWorkRequestList().add(foodDistributionWorkRequest);
        populateApprovedRequestTable();
        populateNewRequestTable();
        populateDisapprovedRequestTable();
